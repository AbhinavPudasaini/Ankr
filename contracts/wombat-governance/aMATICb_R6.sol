...
contract aMATICb_R6 is OwnableUpgradeable, ERC20BondBase, IinternetBond_R2 {
    ...
    function burnBonds(address account, uint256 amount) external override onlyBondMinter {
